...
### validate_customers_modify_scope



```php
private validate_customers_modify_scope(): mixed
```
...
```php
private validate_scopes(mixed $path = &#039;&#039;): mixed
```
...
### cleanup_scope_check_resource



```php
private cleanup_scope_check_resource(mixed $path, mixed $id): mixed
```
