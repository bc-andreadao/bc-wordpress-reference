...
```php
private menu_item(\Pimple\Container $container): mixed
```
...
```php
private cache_control(\Pimple\Container $container): mixed
```
...
```php
private buy_now(\Pimple\Container $container): mixed
```
...
```php
private mini_cart(\Pimple\Container $container): mixed
```
...
```php
private checkout(\Pimple\Container $container): mixed
```
