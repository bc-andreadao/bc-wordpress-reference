...
```php
private render_button(\Pimple\Container $container): mixed
```
...
```php
private render_dialog_template(\Pimple\Container $container): mixed
```
...
```php
private gutenberg(\Pimple\Container $container): mixed
```
