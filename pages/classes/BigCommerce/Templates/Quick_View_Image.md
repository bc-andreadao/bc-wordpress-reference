...
* Full name: `\BigCommerce\Templates\Quick_View_Image`
...
```php
protected get_popup_template(\BigCommerce\Post_Types\Product\Product $product): mixed
```
