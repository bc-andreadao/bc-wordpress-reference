...
* Full name: `\BigCommerce\Settings\Screens\Api_Credentials_Screen`
...
|:---------|:-----------|:-----|:------|
|`NAME`|public| |&#039;bigcommerce_api_credentials&#039;|
...
```php
public validate_credentials(): void
```
...
```php
public get_store_hash(mixed $host): mixed
```
