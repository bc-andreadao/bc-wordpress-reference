...
```php
private title(\WP_Customize_Manager $wp_customize): mixed
```
...
### product_post_type_slug



```php
private product_post_type_slug(\WP_Customize_Manager $wp_customize): mixed
```
...
```php
private description(\WP_Customize_Manager $wp_customize): mixed
```
...
### category_taxonomy_slug



```php
private category_taxonomy_slug(\WP_Customize_Manager $wp_customize): mixed
```
...
```php
private brand_taxonomy_slug(\WP_Customize_Manager $wp_customize): mixed
```
...
```php
private sorting(\WP_Customize_Manager $wp_customize): mixed
```
...
```php
private filtering(\WP_Customize_Manager $wp_customize): mixed
```
...
```php
private columns(\WP_Customize_Manager $wp_customize): mixed
```
...
```php
private per_page(\WP_Customize_Manager $wp_customize): mixed
```
...
```php
private quick_view(\WP_Customize_Manager $wp_customize): mixed
```
...
```php
private search_field(\WP_Customize_Manager $wp_customize): mixed
```
...
### respect_general_inventory_settings



```php
private respect_general_inventory_settings(\WP_Customize_Manager $wp_customize): mixed
```
