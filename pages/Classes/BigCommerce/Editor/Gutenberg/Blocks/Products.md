...
* Full name: `\BigCommerce\Editor\Gutenberg\Blocks\Products`
...
|:---------|:-----------|:-----|:------|
|`NAME`|public|string|&#039;bigcommerce/products&#039;|
...
```php
public __construct(string $assets_url, \BigCommerce\Rest\Shortcode_Controller $shortcode_controller): mixed
```
...
|-----------|------|-------------|
| `$assets_url` | **string** | The assets URL for the block. |
| `$shortcode_controller` | **\BigCommerce\Rest\Shortcode_Controller** | The controller for handling the shortcode. |
