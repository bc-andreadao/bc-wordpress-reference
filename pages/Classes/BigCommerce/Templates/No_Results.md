...
* Full name: `\BigCommerce\Templates\No_Results`
...
|:---------|:-----------|:-----|:------|
|`NO_RESULTS_MESSAGE`|public| |&#039;no_results_message&#039;|
|`RESET_BUTTON_LABEL`|public| |&#039;reset_button_label&#039;|
|`PRODUCT_ARCHIVE_PERMALINK`|public| |&#039;product_archive_permalink&#039;|
...
```php
protected get_no_results_message(): mixed
```
...
```php
protected get_reset_button_label(): mixed
```
