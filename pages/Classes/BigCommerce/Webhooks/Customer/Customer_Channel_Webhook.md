...
# Customer_Channel_Webhook

Class Customer_Channel_Webhook

Sets up the webhook that runs on customer update.

* Full name: `\BigCommerce\Webhooks\Customer\Customer_Channel_Webhook`
...
|:---------|:-----------|:-----|:------|
|`SCOPE`|public| |&#039;store/customer/channel/login/access/updated&#039;|
|`NAME`|public| |&#039;customer_channel_access_update&#039;|
|`HOOK`|public| |&#039;bigcommerce/webhooks/customer_channel_updated&#039;|
